<template>
  <div class="cte-pager">
    <div class="tool-select-size">
      ...
      >
        <el-option
          v-for="item in default_prop_size"
          :key="item"
          :label="`${item}条/页`"
          :value="item"
        />
    ...
    <div class="tool-page">
      <div class="btn-prevest" @click="startPage">
        <el-icon class="icon" color="#2486EE"><DArrowLeft /></el-icon>
      </div>
      <div class="btn-prev" @click="prevPage">
        <el-icon class="icon" color="#2486EE"><CaretLeft /></el-icon>
      </div>
      <div class="symbol-divid"></div>
      ...
      <div class="btn-next" @click="nextPage">
        <el-icon class="icon" color="#2486EE" ><CaretRight /></el-icon>
      </div>
      <div class="btn-nextest" @click="endPage">
        <el-icon class="icon" color="#2486EE"><DArrowRight /></el-icon>
      </div>
      <div class="symbol-divid"></div>
    </div>
    <div class="tool-refresh">
      <div class="btn-refresh" @click="refresh">
        <el-icon class="icon" color="#2486EE"><RefreshRight /></el-icon>
      </div>
    </div>
  </div>
</template>
